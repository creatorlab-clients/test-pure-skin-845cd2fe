...
// Use a real blob URL for preview (or local fallback)
if (!ctx.frameBaseUrl) {
  ctx.frameBaseUrl = 'https://8ispuxmgjxgu2r5q.public.blob.vercel-storage.com/templates/estetica-002/frames/';
}

// Process script.js: string replacement for frameBaseUrl
...
console.log('\nPreview pronta. Apri: http://localhost:8002/template-estetica-002/index-preview.html');
